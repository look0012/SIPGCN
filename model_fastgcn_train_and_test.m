function model_fastgcn_train_and_test(A, X, Y, idx_train, idx_valid, idx_test, szW0, szW1, l2_reg, num_epoch, batch_size, sample_size, adam_param)
...
[~, test_accuracy] = ...
    model_fastgcn_train_and_test_one_epoch(...
        A, X, AX, Y, p, w, szW0, szW1, l2_reg, batch_size1, ...
        sample_size1, adam_param, idx_train, Ytrain_label, update_w);
